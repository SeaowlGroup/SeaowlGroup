...
// [add] #include "asv_ctrl_vo/name_of_your_file.h" 
...
int main(int argc, char *argv[])
{
  ...
  VelocityObstacle *vo = new VelocityObstacle; // [change to] ExerciseLocalPlanner *vo = new ExerciseLocalPlanner;
...
void VelocityObstacleNode::initialize(ros::Publisher *cmd_pub,
                                      ...
                                      VelocityObstacle *vo, // [change to] ExerciseLocalPlanner *vo,
                                      ros::NodeHandle nh)
{
  cmd_pub_ = cmd_pub;
  mk_pub_ = mk_pub;
