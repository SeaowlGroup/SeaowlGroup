...
class Scenario(object):
    ...
    def graphic_interface(self):
        ...
        fenetre.iconphoto(False, PhotoImage(file=f'{rospack.get_path("asv_common")}/images/icon.png'))
        ...
        seagull = PhotoImage(file=f'{rospack.get_path("asv_common")}/images/Seagull-USV.png')
